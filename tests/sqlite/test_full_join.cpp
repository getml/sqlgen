...
TEST(sqlite, test_full_join) {
    ...
    const std::string expected_json =
        R"([{"first_name":"Homer","last_name":"Simpson","pet_name":"Santa's Little Helper"},{"first_name":"Marge","last_name":"Simpson","pet_name":null},{"first_name":"Bart","last_name":"Simpson","pet_name":null},{"first_name":"Lisa","last_name":"Simpson","pet_name":"Snowball"},{"first_name":null,"last_name":null,"pet_name":"Mr. Teeny"}])";

    EXPECT_EQ(sqlite::to_sql(get_all), expected_query);
