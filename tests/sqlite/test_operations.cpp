...
TEST(sqlite, test_operations) {
  ...
  const auto get_children =
      select_from<Person>(
          ...
          abs("age"_c * (-1)) | as<"abs_age">, exp("age"_c) | as<"exp_age">,
          sqrt("age"_c) | as<"sqrt_age">,
  ...
  const std::string expected =
      R"([{"id_plus_age":11,"age_times_2":20,"id_plus_2_minus_age":-7,"age_mod_3":1,"abs_age":10,"exp_age":22026,"sqrt_age":3},{"id_plus_age":10,"age_times_2":16,"id_plus_2_minus_age":-4,"age_mod_3":2,"abs_age":8,"exp_age":2980,"sqrt_age":2},{"id_plus_age":3,"age_times_2":0,"id_plus_2_minus_age":5,"age_mod_3":0,"abs_age":0,"exp_age":1,"sqrt_age":0}])";
